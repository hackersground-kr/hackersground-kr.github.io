...
Slug는 콘텐츠의 고유 식별자로, URL에 그대로 사용됩니다.
...
### 정보글 (post)
> 형식: `YYYY-MM-DD-주제-키워드`

| 예시 slug | 설명 |
|---|---|
| `2026-08-22-ai-game-dev-insight` | 게시 날짜 + 주제 키워드 |
| `2025-07-15-azure-free-tier-guide` | 게시 날짜 + 주제 키워드 |

- 날짜는 **발행일** 기준 `YYYY-MM-DD` 형식으로 시작합니다.
- 주제 키워드는 글의 핵심 내용을 2~4개 단어로 요약합니다.
...
| 예시 slug | 설명 |
|---|---|
| `vibe-coding-workshop` | 행사 주제 키워드만 |
| `ai-builder-meetup` | 행사 주제 키워드만 |

- 행사는 날짜 없이 주제 키워드만 사용합니다. (동일 행사가 반복 개최될 수 있기 때문)
